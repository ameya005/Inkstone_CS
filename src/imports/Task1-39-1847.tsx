import svgPaths from "./svg-4cld7ncay2";
...
export default function Task1() {
  return (
    <div className="box-border content-stretch flex items-start overflow-clip relative rounded-[16px] shadow-[0px_0px_8px_0px_rgba(0,0,0,0.25)] size-full" data-name="Task 1">
      <Frame125 />
      <Frame56 />
    </div>
  );
