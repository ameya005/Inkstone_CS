import svgPaths from "./svg-zzexskzd4f";
    ...
    <div className="relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-center px-[24px] py-[16px] relative w-full">
          <div className="h-[234px] relative rounded-[8px] shrink-0 w-[308px]" data-name="image 2">
            <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[8px]">
              <img alt="" className="absolute h-[131.84%] left-0 max-w-none top-[-29.05%] w-full" src={imgImage2} />
            </div>
          </div>
        </div>
      </div>
...
function Task5() {
  return (
    <div className="basis-0 box-border content-stretch flex grow h-full items-start min-h-px min-w-px overflow-clip relative rounded-[16px] shadow-[0px_0px_8px_0px_rgba(0,0,0,0.25)] shrink-0" data-name="Task 5">
      <Frame125 />
      <Frame56 />
    </div>
  );
...
export default function Assesment5() {
  return (
    <div className="bg-neutral-50 content-stretch flex flex-col gap-[10px] items-start relative size-full" data-name="Assesment5">
      <Frame123 />
    </div>
  );
}