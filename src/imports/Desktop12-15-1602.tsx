import svgPaths from "./svg-eaodf8dsh9";
...
export default function Desktop12() {
  return (
    <div className="bg-neutral-50 content-stretch flex flex-col gap-[10px] items-start relative size-full" data-name="Desktop - 12">
      <Frame123 />
    </div>
  );
}