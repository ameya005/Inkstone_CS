import svgPaths from "./svg-bp54emaoig";
...
function Playground() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] h-[968px] items-start p-[8px] relative shrink-0 w-[1160px]" data-name="Playground">
      <PlaygroundContainer />
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[966px] items-end pl-0 pr-[8px] py-[8px] relative shrink-0 w-[352px]">
      <Frame21 />
    </div>
  );
}
...
function Frame121() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-[64px] top-[56px] w-[1512px]">
      <Playground />
      <Frame63 />
    </div>
  );
