import svgPaths from "./svg-edspiefgdj";
...
function RefreshCw03() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="refresh-cw-03">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="refresh-cw-03">
          <path d={svgPaths.p3bb933e0} id="Icon" stroke="var(--stroke-0, #6155F5)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function CheckDone01() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="check-done-01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="check-done-01">
          <path d={svgPaths.pd23a800} id="Icon" stroke="var(--stroke-0, #6155F5)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Frame76() {
  return (
    <div className="content-stretch flex flex-col h-[829px] items-center justify-between relative shrink-0 w-full">
      <Frame118 />
      <Frame110 />
    </div>
  );
